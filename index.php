...
<main>
	<div class="column half">
		...
		<div class="column full">
			...
			<p class="boast"><a href="http://www.tripadvisor.com/Attraction_Review-g60750-d1990604-Reviews-Bite_San_Diego-San_Diego_California.html"><img class="icon" src="<?php echo get_template_directory_uri(); ?>/images/tripadvisor.png"><strong>Top 10</strong> San Diego Tour on Trip Advisor</a></p>
			<p class="boast"><a href="http://www.yelp.com/biz/bite-san-diego-san-diego"><img class="icon" src="<?php echo get_template_directory_uri(); ?>/images/yelp.png"><strong>500+</strong> Reviews on Yelp</a></p>
		</div>
	</div>
	...
	<div class="column full links">
		<div class="column third spacer talignleft">
			...
			<a href="http://bitesandiego.com/vouchers/"><h3>Got a Voucher? <strong>Lucky You</strong></h3></a>
		</div>
		<div class="column third spacer talignleft">
		...
		<div class="column third spacer talignright">
				<img width="115px" src="<?php echo get_template_directory_uri(); ?>/images/chips.png" class="alignleft">
